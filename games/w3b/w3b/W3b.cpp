...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
  ...
  HWND hwnd = ::CreateWindowExW(
      WS_EX_LAYERED, wc.lpszClassName, _T("Dear ImGui DirectX11 Example"),
  ...
  SetLayeredWindowAttributes(hwnd, 0, 0x22, 0x02);
  // Initialize Direct3D
  ...
  ImVec4 clear_color = ImVec4(125.0f, 11.0f, 11.0f, 1.0f);
  ...
  while (msg.message != WM_QUIT) {
    ...
    // to created a named window.
    {
      ...
      drawList->AddLine({0.f, 0.f}, {200.f, 200.f}, ImColor(255, 96, 0, 255),
                        5);
    }
